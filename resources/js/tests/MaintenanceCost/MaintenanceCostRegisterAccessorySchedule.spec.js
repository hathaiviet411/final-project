...
import MaintenanceCostRegisterAccessorySchedule from '@/pages/MaintenanceCost/PeriodicInspections';
...
describe('TEST COMPONENT MAINTENANCE COST REGISTER PERIODIC INSPECTIONS', () => {
    ...
    const wrapper = mount(MaintenanceCostRegisterAccessorySchedule, {
        localVue,
        router,
        store,
        mocks,
