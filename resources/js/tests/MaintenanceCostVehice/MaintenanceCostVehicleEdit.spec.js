...
import MaintenanceCostDataEdit from '@/pages/MaintenanceCostData/Edit';
...
describe('TEST COMPONENT MAINTENANCE COST EDIT', () => {
    ...
    const backToDetailScreen = jest.fn();
    const saveUpdateData = jest.fn();

    const localVue = createLocalVue();
    const wrapper = mount(MaintenanceCostDataEdit, {
        localVue,
        router,
        store,
        mocks,
    ...
    test('Test function saveUpdateData', async() => {
        await wrapper.setData({
            body_id: 'Mèo Body Model Number',
            body_id_date: '2022-02-23',
            camera_monitor: 'Mèo Camera Monitor',
            camera_monitor_date: '2022-02-24',
            gate: 'Mèo Gate',
            gate_date: '2022-02-25',
            glass: 'Mèo Glass',
            glass_date: '2022-02-22',
            other: 'Mèo Others',
            other_date: '2022-02-26',
            remark_01: 'Mèo Remark 01',
            remark_02: 'Mèo Remark 02',
        });

        await wrapper.vm.saveUpdateData();
        expect(saveUpdateData).toHaveBeenCalled();
    });

    wrapper.destroy();
});

describe('TEST COMPONENT VEHICLE DATA EDIT', () => {
    const mocks = {
        $bus: {
            on: jest.fn(),
            once: jest.fn(),
